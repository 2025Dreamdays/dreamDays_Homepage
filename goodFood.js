...
const listView = (foodList) => {
    ...
    foodList.forEach(food => {
        ...
        FoodImg.setAttribute("src", food.img);
        FoodImg.setAttribute("class", "foodImg")

        const FoodTextMainDiv = document.createElement("div");
        FoodTextMainDiv.setAttribute("class", "foodTextMainDiv");
        ...
        if (food.category) {
            ...
            FoodCategory.innerText = food.category;
            if (food.category === "한식맛집") {
                FoodCategory.classList.add('korea');
            } else if (food.category === "양식맛집") {
                FoodCategory.classList.add('sheep');
            } else if (food.category === "중식맛집") {
                FoodCategory.classList.add('china');
            } else if (food.category === "분식맛집") {
                FoodCategory.classList.add('snack');
            }
            FoodMainDiv.appendChild(FoodCategory);
        ...
        FoodMainDiv.appendChild(FoodImg);
        FoodMainDiv.appendChild(FoodTextMainDiv);
        FoodTextMainDiv.appendChild(FoodNameDiv);
        FoodTextMainDiv.appendChild(FoodLocationDiv);
        FoodTextMainDiv.appendChild(FoodMenuDiv);
        FoodTextMainDiv.appendChild(FoodtextDiv);
